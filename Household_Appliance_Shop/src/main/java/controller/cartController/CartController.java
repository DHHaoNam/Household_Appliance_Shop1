...
public class CartController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<CartItem> cartList = cartDAO.getcart(customerId);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (removeProductIdStr != null) {
            ...
            dao.removeCartItem(customerID, removeProductId);

            // Cập nhật session sau khi xóa sản phẩm
            List<CartItem> updatedCartList = dao.getcart(customerID);
            session.setAttribute("cartlists", updatedCartList);
            ...
            for (int i = 0; i < productIds.length; i++) {
                ...
                dao.updateCartItemQuantity(customerID, productId, quantity);
                session.setAttribute("cartlists", dao.getcart(customerID));
